                ...
                <tbody>
                    <?php foreach ($view_hotel as $hotel) { ?> 
						<tr>
							...
							<td>
								<a href="<?=base_url()?>admin/edit_hotel/<?=$hotel['ID']?>" class="edit" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>
								<a href="<?=base_url()?>admin/delete_hotel/<?=$hotel['ID']?>" onclick="return checkdelete()" class="delete" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
							</td>
						</tr>		 
					<?php } ?>     
                </tbody>
