...
<head>
	...
	<!-- //Web-Fonts -->
	<!-- Index-Page-CSS -->
    <link rel="stylesheet" href="<?=base_url()?>asset3/css/style.css" type="text/css" media="all">
    <!-- onlinefonts -->
    <link href="<?=base_url()?>asset3///fonts.googleapis.com/css?family=Dosis:200,300,400,500,600,700,800" rel="stylesheet">
