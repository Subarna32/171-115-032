                            ...
                            <div class="position-center">
                                <form role="form" action="" method="post" enctype="multipart/form-data"  >
									...
									<div class="form-group">
										...
										<input type="password" class="form-control" id="password" value="<?php if(set_value('user_password')){ echo set_value('user_password'); }else{ echo $user[0]['Password']; }  ?>" placeholder="Enter Password" name="user_password">
										<div class="error"><?=form_error('user_password')?></div>
									</div>
									
									<div class="form-group">
										<label for="">Confirm Password</label>
										<input type="password" class="form-control" id="password" value="<?php if(set_value('user_password')){ echo set_value('user_password'); }else{ echo $user[0]['Password']; } ?>" placeholder="Enter Confirm Password" name="user_c_password">
