    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li <?php if($this->uri->segment(2)=='hotel/home'){ echo 'class="active"'; } ?>>
                    <a class="active" href="<?=base_url()?>hotel/home">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?=base_url()?>hotel/insert_hotel">Hotel Information</a></li>
                        <li><a href="<?=base_url()?>hotel/insert_gallery">Gallery</a></li>
                    </ul>
                </li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?=base_url()?>hotel/view_hotel">Hotel Information</a></li>
                        <li><a href="<?=base_url()?>hotel/view_bookings">New Bookings</a></li>
                        <li><a href="<?=base_url()?>hotel/view_gallery">Gallery</a></li>
                    </ul>
                </li>
